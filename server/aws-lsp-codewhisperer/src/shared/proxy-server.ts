...
import { LocalProjectContextServerFactory } from '../language-server/localProjectContext/localProjectContextServer'
...
export const QLocalProjectContextServerTokenProxy = LocalProjectContextServerFactory(getOrThrowBaseTokenServiceManager)
export const QLocalProjectContextServerIAMProxy = LocalProjectContextServerFactory(getOrThrowBaseIAMServiceManager)
